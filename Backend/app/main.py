...
def reanalyze_video(
    ...
    try:
        ...
        print(
            f"Starting fresh analysis: {video_id}"
        )
        ...
        print(
            f"Redis cache deleted: {video_id}"
        )
        ...
        print(
            f"Fresh analysis completed: {video_id}"
        )
